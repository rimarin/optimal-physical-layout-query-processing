...
AND tpep_pickup_datetime > ':5' AND
    tpep_pickup_datetime < ':6' AND
    tpep_dropoff_datetime > ':7' AND
    tpep_dropoff_datetime < ':8'
AND
    passenger_count > ':9' AND passenger_count < ':10' AND
    fare_amount > ':11' AND fare_amount < ':12' AND
    trip_distance > ':13' AND trip_distance < ':14'

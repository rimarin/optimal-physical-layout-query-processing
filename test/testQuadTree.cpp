...
TEST_F(TestOptimalLayoutFixture, TestPartitioningQuadTree){
    ...
    auto pathPartition1 = quadTreeFolder / (datasetSchoolName + "1" + fileExtension);
    ...
    auto pathPartition2 = quadTreeFolder / (datasetSchoolName + "2" + fileExtension);
    ...
    auto pathPartition3 = quadTreeFolder / (datasetSchoolName + "3" + fileExtension);
    ...
    auto pathPartition4 = quadTreeFolder / (datasetSchoolName + "4" + fileExtension);
    ...
    auto pathPartition5 = quadTreeFolder / (datasetSchoolName + "5" + fileExtension);

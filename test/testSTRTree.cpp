...
TEST_F(TestOptimalLayoutFixture, TestPartitioningSTRTree){
    ...
    arrow::Status statusSTRTree1 = storage::DataWriter::WritePartitions(partitions1, dataset, folder);
    auto pathPartition1_0 = folder / (dataset + "0" + fileExtension);
    ...
    arrow::Status statusSTRTree2 = storage::DataWriter::WritePartitions(partitions2, dataset, folder);
    auto pathPartition2_0 = folder / (dataset + "0" + fileExtension);
    ...
    auto pathPartition2_1 = folder / (dataset + "1" + fileExtension);
    ...
    auto pathPartition2_2 = folder / (dataset + "2" + fileExtension);
    ...
    auto pathPartition2_3 = folder / (dataset + "3" + fileExtension);

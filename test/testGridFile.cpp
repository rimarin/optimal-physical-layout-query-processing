...
TEST_F(TestOptimalLayoutFixture, TestPartitioningGridFile){
    ...
    auto partitions = gridFilePartitioning->partition(*table, partitioningColumns, partitionSize).ValueOrDie();
    arrow::Status statusGridFile = storage::DataWriter::WritePartitions(partitions, dataset, folder);

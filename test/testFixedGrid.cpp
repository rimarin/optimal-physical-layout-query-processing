...
TEST_F(TestOptimalLayoutFixture, TestPartitioningFixedGrid){
    ...
    ASSERT_EQ(readColumn<arrow::Int32Array>(pathPartition0, "y"), std::vector<int32_t>({45, 10}));
    ...
    ASSERT_EQ(readColumn<arrow::Int32Array>(pathPartition1, "y"), std::vector<int32_t>({35, 15}));
    ...
    ASSERT_EQ(readColumn<arrow::Int32Array>(pathPartition2, "y"), std::vector<int32_t>({42, 5}));

...
TEST_F(TestOptimalLayoutFixture, TestPartitioningFixedGrid){
    ...
    auto partitions = fixedGridPartitioning->partition(*table, partitioningColumns, partitionSize).ValueOrDie();
    arrow::Status statusFixedGrid = storage::DataWriter::WritePartitions(partitions, dataset, folder);
